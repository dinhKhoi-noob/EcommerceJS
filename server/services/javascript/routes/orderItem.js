...
route.post('/',orderItemMiddleware.nullCheck,orderItemMiddleware.orderCheck,orderItemMiddleware.productCheck,(req,res)=>{
    ...
    try {
        ...
        connection.query(`INSERT INTO order_items (visible_id, order_id, product_id) VALUES ('${visible_id}', '${order_id}', '${product_id}')`,(err,result)=>{
...
route.get('/:id',(req,res)=>{
    ...
    try {
        connection.query(`select visible_id,product_id from order_items where order_id='${order_id}'`,(err,result)=>{
